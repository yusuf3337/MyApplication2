    ...
    private fun saveUserDataToFirestore(imageReference: StorageReference) {
        imageReference.downloadUrl
            .addOnSuccessListener { uri ->
                ...
                userMap.put("Fiyat", SallerHomeSingelton.fiyat!!)
                userMap.put("M2(Net)", SallerHomeSingelton.m2!!)
                userMap.put("Oda Sayısı", SallerHomeSingelton.odaSayisi!!)
                userMap.put("Bina Yaşı", SallerHomeSingelton.binaYasi!!)
                userMap.put("Banyo Sayısı", SallerHomeSingelton.banyoSayisi!!)
                userMap.put("Balkon", SallerHomeSingelton.balkon!!)
                userMap.put("CreateDateUser", com.google.firebase.Timestamp.now())
                userMap.put("Eşyalı", SallerHomeSingelton.esyali!!)
                userMap.put("Kat Sayısı", SallerHomeSingelton.katSayisi!!)
                userMap.put("Bulunduğu Kat", SallerHomeSingelton.bulunduguKat!!)
                ...
                userMap.put("Isıtıma", SallerHomeSingelton.isitma!!)
                userMap.put("Öğrenciye Uygun", SallerHomeSingelton.ogrenciyeUygun!!)
